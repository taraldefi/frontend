            ...
            <div className={"tablePersons"}>
                <div className="tableTitles">
                    <div className="statusTitle">
                        {["Persons", "Email", "Position", "Verification Status", "Status Verification", "Options"].map((item, index) => {
                            return (
                ...
                {TableData.map((item, index) => {
                    return (
                        <div className="tabelContent" key={index}>
                            ...
                            <div className="sv">
                                {item.StatusVerificatoin ? <div className="sent">Sent</div> : <div className="notSent">Not Sent</div>}
                            </div>
                            <div className="vs">
                                {item.VerificationStatus ? <div className="notDone">Completed</div> : <div className="complete">Not Done</div>}
                            </div>
