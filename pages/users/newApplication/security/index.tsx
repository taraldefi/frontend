            ...
            <div className="securityContainer">
                <div className="securityContent">
                    ...
                    <div className="collateral">
                                ...
                                <div className="radioBackIn">
                                    <div>
                                        ...
                                        <select className="inputs" >
                                            <option value="" disabled selected hidden >Monetary</option>
                                            <option value="" ></option>
                                            <option value="" ></option>
                                        </select>
                                    </div>
                                    <div className="edit">
                                        <span>
                                            Guarantee/security type name?
                                        </span>
                                        <input type="text" className="inputs" placeholder="Global Guarantee" />
                                    </div>

                                    <div>
                                        <span>Proportion of goods cover by security</span>
                                        <input type="text" placeholder="50" id="percentage" className="inputs" />
                                    </div>
                                    ...
                                    <div>
                                        <span>When security/collateral received later exact date</span>
                                        <input type="date" className="inputs" id="calendar" />
                                    </div>
                                    <div>
                                        <span>Security/collateral provider address</span>
                                        <input type="text" className="inputs" placeholder="17 Albert-Hößler-Straße, Berlin" />
                                    </div>
                                </div>
                            ) : (
                                <></>
                        ...
                        {selectedRadioBtn == "Yes" ? (<div className="radioBack">
                            <span>Has significant influence on security/collateral provider?</span>
                            <div>
                                <div>
                                    <input
                                        type="radio"
                        ...
                        {selectedRadioBtn == "Yes" ? (<div className="radioBack">
                            <span>Has payment experience with security/collateral provider</span>
                            <div>
                                <div>
                                    <input
                                        type="radio"
