        ...
        <div className="relContainer">
          <div className="shareholdRel">
            ...
            <div className="radioBack">
              <span>Do you have a shareholding relationship with the importer/buyer?</span>
              <div>
                <div>
                  <input
                    type="radio"
              ...
              {selectedRadioBtn == "Yes" ?
                <div className="inputContainer">
                  ...
                  <input type="text" className="inputs" placeholder="Business relationship" />
                </div>
                :
                <></>
              }
          ...
          <div className="influenceRel">
            ...
            <div className="radioBack">
              <span>Do you have a significant influence on the importer management?</span>
              <div>
                <div>
                  <input
                    type="radio"
              ...
              {selectedRadioBtn1 == "Yes" ?
                <>
                  <div className="inputContainer">
                    <span>Explain the influence on the importer management.</span>
                    <input type="text" className="inputs" placeholder="15% share" />
                  </div>
                </>
                :
                <></>
              ...
              {selectedRadioBtn2 == "Yes" ?
                <>
                  <div className="inputContainer">
                    ...
                    <input type="text" className="inputs" placeholder="International transfer" />
                  </div>
                  <div className="inputContainer">
                    <span>Length of payment experience</span>
                    <input type="text" className="inputs" placeholder="3 Months" />
                  </div>
                  <div className="inputContainer">
            ...
            {selectedRadioBtn2 == "Yes" ?
              <div className="selectBack">
                ...
                <div className="inputContainer">
                  ...
                  <input type="text" className="inputs" placeholder="Customs clearence delay" />
                </div>
              </div>
              :
              <></>
