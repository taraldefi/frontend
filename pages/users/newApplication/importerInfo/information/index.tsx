        ...
        <div className="infoContainer">
          <div className="importerInfo">
            ...
            <div className="inputContainer">
              ...
              <input type="text" className="inputs" placeholder="Phone number..." />
            </div>
            <div className="inputContainer">
            ...
            <div className="inputContainer">
              ...
              <input type="text" className="inputs" placeholder="Address line 1..." />
            </div>
            <div className="inputContainer">
              <span>Importer company address line 2</span>
              <input type="text" className="inputs" placeholder="Address line 2..." />
            </div>
            <div className="inputContainer">
              <span>Importer post code</span>
              <input type="text" className="inputs" placeholder="Post code..." />
            </div>
          </div>
          ...
          <div className="deliveryAddress">
            ...
            <div className="radioBack">
              <span>Is the delivery address different to the importer company address?</span>
              <div>
                <div>
                  <input
                    type="radio"
              ...
              {selectedRadioBtn == "Yes" ?
                <>
                  <div className="inputContainer">
                    ...
                    <input type="text" className="inputs" placeholder="Global Traders" />
                  </div>
                  <div className="inputContainer">
                  ...
                  <div className="inputContainer">
                    ...
                    <input type="text" className="inputs" placeholder="Berlin" />
                  </div>
                  <div className="inputContainer">
            ...
            <div className="radioBack">
              ...
              {selectedRadioBtn1 == "Yes" ?
                <div className="inputContainer">
                  ...
                  <input type="text" className="inputs" placeholder="Address..." />
                </div>
                :
                <></>
              }
