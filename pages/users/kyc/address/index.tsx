      ...
      <div className="outerContainerKyc">
        <div className="InnerContainer1">
          ...
          <div className="inputContainer">
            ...
            <input type="text" className="inputs" placeholder="Albert-Hößler-Straße"/>
          </div>
          <div className="inputContainer">
            <span>Post code</span>
        ...
        <div className="InnerContainer2">
          ...
          <div className="inputContainer">
            ...
            <input type="text" className="inputs" placeholder="Business expansion in Europe"/>
          </div>
          <div className="inputContainer">
            <span>Source of funds to be used in future repayments</span>
            <input type="text" className="inputs" placeholder="Future revenue"/>
          </div>
        </div>
